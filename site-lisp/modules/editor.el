...
(use-package general
  ...
  (with-eval-after-load 'evil
    ...
    (my/mode-leader-def
      ...
      "y" '(org-rich-yank :which-key "rich yank")
      "L" '(org-latex-preview :which-key "LaTeX preview")
      "v" '(my/org-notes-status :which-key "notes repository")
      "e" '(:ignore t :which-key "export")
      "e e" '(org-export-dispatch :which-key "export dispatcher")
      "e h" '(org-hugo-export-wim-to-md :which-key "export Hugo post")
      "e a" '(my/org-hugo-export-all :which-key "export all Hugo posts")
      "x" '(:ignore t :which-key "Babel")
      "x e" '(org-babel-execute-src-block :which-key "execute block")
      "x t" '(org-babel-tangle :which-key "tangle")
      "x p" '(my/org-babel-python-environment :which-key "Python environment")
      "x s" '(my/org-babel-select-python :which-key "select Python")
